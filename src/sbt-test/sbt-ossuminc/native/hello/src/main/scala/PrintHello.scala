/** ********************************************************************************************************************
  * * Copyright (c) 2015, Ossum Inc.. All Rights Reserved. * * Licensed under the Apache License, Version 2.0 (the
